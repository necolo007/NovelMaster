...
python3 skills/novel-master/scripts/chapter_memory.py <project_path> [--span 10|20]
python3 skills/novel-master/scripts/toc_generator.py <project_path>
python3 skills/novel-master/scripts/export_all.py <project_path>
...
python3 skills/novel-master/scripts/build_web_manifest.py [project_path]

# Node fallbacks when Python is unavailable
node chapter_memory.js <project_path> --span=10
...
- `index.html` / `viewer.html` — built-in local web app for browsing project chapters and export files.
- `web/projects.json` — web app manifest generated by `build_web_manifest.py`.
- `projects/` — user project workspace.
- `projects/<name>/memory/` — archived chapter batches and long-term continuation memory.
